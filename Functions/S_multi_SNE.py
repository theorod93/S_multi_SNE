...
Disclaimers: (A) Part of the code is taken directly from the original author of t-SNE found in this link: https://lvdmaaten.github.io/tsne/
             (B) Part of the code is taken directly from the original author of multi-SNE found in this link: https://github.com/theorod93/multiView_manifoldLearning
'''
